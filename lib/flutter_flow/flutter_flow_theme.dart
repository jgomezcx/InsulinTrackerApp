...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0x4C6551FF);
  ...
  late Color lineColor = const Color(0xFFE3E6EC);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryBackground = const Color(0xFF202121);
  ...
  late Color primaryBtnText = const Color(0xFFFFFFFF);
  late Color lineColor = const Color(0xFF343C45);
  late Color backgroundComponents = const Color(0xFF1D2428);
}
