                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 12.0, 0.0, 0.0),
                                            child: Text(
                                              'Message us about bugs or feedback!',
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    await launchURL(
                                        'https://www.wcu.edu/WebFiles/PDFs/CalculatingInsulin.pdf');
                                  },
                                  child: Container(
                                    width: 120.0,
                                    constraints: const BoxConstraints(
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 12.0, 0.0, 2.0),
                                            child: Text(
                                              'Link to tutorial on how to use!',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                        ...
                                                        padding:
                                                            const EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'image uploads are disbaled for now',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelMedium
                                                              .override(
                                        ...
                                        if (confirmDialogResponse) {
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                title: const Text(
                                                    'request for deletion sent'),
                                                content: const Text(
                                                    'The request for deleteing your account has been set. Watch email for message about deleted account'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
